...
<section class="text-gray-600 body-font relative">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-12">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">管理者ログイン</h1>
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base">登録カウンセラーの方は、カウンセラーメニュー配下の<a href="login_counselor.php">ログイン</a>をご利用ください。</p>
    </div>

    <form name="form1" action="login_act_admin.php" method="post">   
